...
export default {
	...
	methods: {
		...
		upload_files(opts) {
			...
			if (opts) {
				this.attachment_type = opts.attachment_type;
			} else {
				console.log("no attachment type");
			}
		...
		upload_file(file, i) {
			...
			return new Promise((resolve, reject) => {
				...
				xhr.open('POST', '/api/method/peark.controllers.attachments.upload_file', true);
				...
				if (this.attachment_type) {
					form_data.append('attachment_type', this.attachment_type);
				}
